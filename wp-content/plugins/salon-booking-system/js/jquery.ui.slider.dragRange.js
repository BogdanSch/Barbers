(function( $, undefined ) {
  ...
  $.widget("ui.dragslider", $.ui.slider, {
    ...
    options: $.extend({},$.ui.slider.prototype.options,{rangeDrag:false, rangeDragStep: $.ui.slider.prototype.options.step}),

    _create: function() {
      this._step = this.options.step;
      this.options.step = this.options.rangeDragStep;
