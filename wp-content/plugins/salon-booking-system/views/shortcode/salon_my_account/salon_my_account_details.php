...
<ul class="nav nav-tabs sln-salon-my-account-tab-nav" role="tablist">
	<li class="col-xs-12 col-sm-4 col-md-4 active" role="presentation"><a data-target="#new" aria-controls="new" role="tab" data-toggle="tab"><?php _e('Next appointments', 'salon-booking-system')?></a></li>
	<li class="col-xs-12 col-sm-4 col-md-4" role="presentation"><a data-target="#old" aria-controls="old" role="tab" data-toggle="tab"><?php _e('Reservations history', 'salon-booking-system')?></a></li>
	<li class="col-xs-12 col-sm-4 col-md-4" role="presentation"><a data-target="#profile" aria-controls="profile" role="tab" data-toggle="tab"><?php _e('Update your profile', 'salon-booking-system')?></a></li>
</ul>
