<table width="194" cellspacing="0" cellpadding="0" border="0">
    ...
    <?php if (!SLN_Enum_CheckoutFields::getField('firstname')->isHidden() || !SLN_Enum_CheckoutFields::getField('lastname')->isHidden()): ?>
    <tr>
    ...
    <?php if (!SLN_Enum_CheckoutFields::getField('phone')->isHidden()): ?>
	<tr>
	    <td align="left" valign="top" style="font-size:14px;line-height:20px;color:#4d4d4d;font-weight:500;font-family: 'Avenir-Medium',sans-serif,arial;padding: 0 0 0 9px;" class="pad0">
    ...
    <?php endif; ?>
    <?php if (!SLN_Enum_CheckoutFields::getField('address')->isHidden()): ?>
	<tr>
	    <td align="left" valign="top" style="font-size:14px;line-height:20px;color:#4d4d4d;font-weight:500;font-family: 'Avenir-Medium',sans-serif,arial;padding: 0 0 0 9px;" class="pad0">
