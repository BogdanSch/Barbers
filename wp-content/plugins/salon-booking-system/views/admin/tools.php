				...
				<div class="row">
					<div class="col-xs-12 col-lg-6">
						<div class="row">
								...
								<div id="import-customers-drag" class="preview-logo">
                                    <div class="info">
                                        <div class="info-wrap">
                                            ...
                                            <span class="text"
                                                  placeholder="<?php _e('drag your csv file here to import your “Customers”', 'salon-booking-system') ?>">
											<?php _e('drag your csv file here to import your “Customers”', 'salon-booking-system') ?></span>
                                        </div>
                                        <button type="button" class="sln-btn sln-btn--main sln-btn--big pull-right"
                            ...
                            <div class="col-xs-12 form-group">
                                <a class="sln-item-csv" href="<?php echo SLN_PLUGIN_URL . '/csv-import-samples/Salon import sample customers.csv'; ?>"><?php _e('Download sample CSV file', 'salon-booking-system') ?></a>
                            </div>
                        </div>
                    </div>
								...
								<div id="import-services-drag" class="preview-logo">
                                    <div class="info">
                                        <div class="info-wrap">
                                            <span class="info-upload" aria-hidden="true"></span>
                                            <span class="text"
                                                  placeholder="<?php _e('drag your csv file here to import “Services”', 'salon-booking-system') ?>">
							...
							<div class="col-xs-12 form-group">
								<div class="row">
									<div class="col-xs-12 col-sm-6">
                                        <a class="sln-item-csv" href="<?php echo SLN_PLUGIN_URL . '/csv-import-samples/Salon import sample services.csv'; ?>"><?php _e('Download sample CSV file', 'salon-booking-system') ?></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-xs-12 col-lg-6">
						<div class="row">
								...
								<div id="import-assistants-drag" class="preview-logo">
                                    <div class="info">
                                        <div class="info-wrap">
                                            <span class="info-upload" aria-hidden="true"></span>
                                            <span class="text"
                                                  placeholder="<?php _e('drag your csv file here to import your “Assistants”', 'salon-booking-system') ?>">
                                    			<?php _e('drag your csv file here to import your “Assistants”', 'salon-booking-system') ?></span>
                                        </div>
                                        <button type="button" class="sln-btn sln-btn--main sln-btn--big pull-right"
							...
							<div class="col-xs-12 form-group">
								<div class="row">
									<div class="col-xs-12 col-sm-6">
										<a class="sln-item-csv" href="<?php echo SLN_PLUGIN_URL . '/csv-import-samples/Salon import sample assistants.csv'; ?>"><?php _e('Download sample CSV file', 'salon-booking-system') ?></a>
									</div>
								</div>
							</div>
						</div>
