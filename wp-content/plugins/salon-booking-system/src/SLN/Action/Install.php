...
class SLN_Action_Install
{
	...
	$adminRole = get_role('administrator');
        return (bool) get_option(SLN_Settings::KEY) && (!$adminRole || (isset($adminRole->capabilities['manage_salon_settings']) && isset($adminRole->capabilities['create_sln_bookings']) && isset($adminRole->capabilities['edit_sln_discounts'])));
    }
